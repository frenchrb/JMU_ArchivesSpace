...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns2="http://www.w3.org/1999/xlink" xmlns:local="http://www.yoursite.org/namespace" xmlns:ead="urn:isbn:1-931666-22-9" version="2.0"  exclude-result-prefixes="#all">
    ...
    <xsl:function name="local:tagName">
        ...
        <xsl:choose>
            ...
            <xsl:when test="$tag = 'controlaccess'">Index Terms</xsl:when> <!-- RBF was "Controlled Access Headings" -->
            ...
            <xsl:when test="$tag = 'genreform'">Genre and Form</xsl:when> <!-- RBF was "Genre/Physical Characteristic" -->
            ...
            <xsl:when test="$tag = 'physdesc'">Extent</xsl:when> <!-- RBF was "Physical Description" -->
            ...
            <xsl:when test="$tag = 'publicationstmt'">Location</xsl:when> <!-- RBF was "Publication Statement" -->
            ...
            <xsl:when test="$tag = 'unitid'">Collection No.</xsl:when> <!-- RBF was "ID" -->
